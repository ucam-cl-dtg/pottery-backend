...
/**
 * A two phase countdown latch. Threads can concurrently acquire and release the latch until someone
 * calls await(). After await is called new threads are refused at the acquire point. Await returns
 * after all threads release()
 *
 * @author acr31
 */
